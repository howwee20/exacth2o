...
- Autostart entry: `/home/alarm/.config/autostart/exacth2o-gas-mixer-agent.desktop`
...
The portal creates five-minute view or control sessions. Only users with an
explicit `system_admin_installation_access` capability may create them. A
